...
class UpstreamDampedDragAnimation(
    ...
    val onDragStarted: UpstreamDampedDragAnimation.(position: Offset) -> Unit,
    val onDragStopped: UpstreamDampedDragAnimation.() -> Unit,
    val onDrag: UpstreamDampedDragAnimation.(size: IntSize, dragAmount: Offset) -> Unit,
) {
