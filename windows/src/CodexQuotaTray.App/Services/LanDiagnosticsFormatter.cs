...
internal static class LanDiagnosticsFormatter
{
        ...
        DateTimeOffset now)
    {
        var lines = new List<string>
        {
            ...
            "",
            "Windows service:",
            "listenerObservation=application-lifecycle (not an OS LISTEN snapshot)",
            "networkContextSource=timestamped-candidate-events",
            "networkProfile=unavailable",
            "eventClock=UTC + monotonicMs; correlate within processSession",
